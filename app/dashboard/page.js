      ...
      steps: [
        {
          ...
          popover: {
            ...
            description: 'This is your central hub for monitoring workplace activities.',
          }
        },
        {
          ...
          popover: {
            ...
            description: 'These are the workplace activities you are currently monitoring.',
          }
        },
        {
          ...
          popover: {
            ...
            description: 'Add and manage employees that will be monitored by the system.',
          }
        },
        {
          ...
          popover: {
            ...
            description: 'Click here to add new employees to the monitoring system.',
          }
        }
      ]
    });
    ...
    <div className="min-h-screen bg-muted">
      ...
      <main className="container mx-auto px-6 py-8">
        <div id="dashboard-header" className="mb-10">
          ...
          <p className="text-gray-600">Manage your workplace monitoring system</p>
        </div>
          ...
          <div className="lg:col-span-2">
            <section id="subscriptions-section" className="dashboard-section">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-primary">Subscribed Activities</h2>
                <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {subscriptions.length > 0 ? (
                  subscriptions.map((subId) => {
                    const activity = activityOptions.find(a => a.id === subId);
                    return (
                      <div key={subId} className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                        <h3 className="font-medium mb-1">{activity?.title || subId}</h3>
                        <p className="text-sm text-gray-500">{activity?.description || 'Activity monitoring enabled'}</p>
                      </div>
                    );
                  })
                ) : (
                  <div className="col-span-2 bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                    <p className="text-gray-500">No activities subscribed yet.</p>
                  </div>
                )}
              </div>
            </section>
      ...
      {showEmployeeForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-2xl w-full m-4">
            ...
            <EmployeeForm onSuccess={handleAddEmployee} onCancel={() => setShowEmployeeForm(false)} />
          </div>
        </div>
      )}
    </div>
