      ...
      steps: [
        {
          ...
          popover: {
            ...
            description:
              "Select the monitoring activities you want to enable for your organization.",
          },
        },
        {
          ...
          popover: {
            ...
            description:
              "Click on any activity to select or deselect it. You can choose multiple activities.",
          },
        },
        {
          ...
          popover: {
            ...
            description:
              "After selecting your desired activities, click here to proceed to employee setup.",
          },
        },
      ],
    });
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 mb-8">
            Choose which activities you want to monitor in your workplace. You
